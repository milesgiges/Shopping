    ...
    <body>
        <div>
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Kshs <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="https://limoworlds.in">LIMOWORLDS STORE</a> Store. All Rights Reserved.</p>
